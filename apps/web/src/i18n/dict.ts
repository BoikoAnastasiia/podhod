...
export const dict = {
  en: {
    ...
    "days.emptyHint": "Add a first day — the button above creates one instantly.",
    "icon.change": "Icon",
    "icon.none": "None",
  ...
  ru: {
    ...
    "days.emptyHint": "Добавьте первый день — кнопка выше создаст его мгновенно.",
    "icon.change": "Значок",
